...
class FermentablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fermentable" do
    assert_difference('Fermentable.count') do
      post fermentables_url, params: { fermentable: { color: @fermentable.color, grain_group: @fermentable.grain_group, name: @fermentable.name, potential: @fermentable.potential, type: @fermentable.type } }
    end
  ...
  test "should update fermentable" do
    patch fermentable_url(@fermentable), params: { fermentable: { color: @fermentable.color, grain_group: @fermentable.grain_group, name: @fermentable.name, potential: @fermentable.potential, type: @fermentable.type } }
